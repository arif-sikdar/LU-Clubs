...
class LuscReg extends StatefulWidget {
  const LuscReg({Key? key}) : super(key: key);

  @override
  State<LuscReg> createState() => _LuscRegState();
}

class _LuscRegState extends State<LuscReg> {
  ...
  _sendtoDB() async{
    ...
    for (var queryDocumentSnapshot in querySnapshot.docs) {
      ...
      CollectionReference _collectionRef = FirebaseFirestore.instance.collection("lusc-reg-info");
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('LUSC Registration', style: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
